...
def generate_launch_description():
    ...
    world_file = '/home/ubuntu/ros2_ws/src/gazebo_models/worlds/test_city.world'
    pioneer_model_path = '/home/ubuntu/ros2_ws/src/pioneer3at_gz/models/Pioneer3AT/model.sdf'

    # Set GAZEBO_MODEL_PATH to include both directories
    env = os.environ.copy()
    gazebo_model_path = (
        '/home/ubuntu/ros2_ws/src/gazebo_models/models:'
        '/home/ubuntu/ros2_ws/src/pioneer3at_gz/models'
    )
